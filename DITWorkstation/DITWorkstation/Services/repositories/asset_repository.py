...
class AssetRepository(BaseRepository):
    ...
    def log_id_by_path(self, file_path: str) -> Optional[str]:
        with self._connection() as conn:
            row = conn.execute(
    ...
    def update_path(self, asset_id: str, new_path: str, new_name: Optional[str] = None) -> bool:
        try:
            with self._transaction() as conn:
                if new_name:
                    conn.execute(
    ...
    def _filter_clause(
        self, project_id: Optional[str] = None, scene: Optional[str] = None,
        shot: Optional[str] = None, file_type: Optional[str] = None,
        date_from: Optional[str] = None, date_to: Optional[str] = None,
        keyword: Optional[str] = None, log_id: Optional[str] = None,
        rating: Optional[int] = None, tag: Optional[str] = None,
    ) -> tuple[str, list]:
    ...
    def iter_search(self, *, batch_size: int = 500,
                    cursor: Optional[tuple[str, str]] = None,
                    limit: Optional[int] = None, offset: Optional[int] = None, **filters):
    ...
    def update_log_id(self, asset_id: str, log_id: Optional[str]) -> bool:
        try:
            with self._transaction() as conn:
                if log_id is None:
                    conn.execute(
    ...
    def add_backup_locations(
        self, file_paths: list[str], target_path: str, project_id: Optional[str] = None,
    ) -> int:
