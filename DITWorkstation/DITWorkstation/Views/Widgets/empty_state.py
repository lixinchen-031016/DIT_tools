...
def attach_empty_state(table: QTableWidget, icon: str, title: str, hint: str = ""):
    """为 QTableWidget 附加空状态提示。
...
def sync_empty_state(table: QTableWidget):
    """根据表格行数同步显示/隐藏空状态提示。
...
def _install_resize_handler(table: QTableWidget):
